...
void MX_TIM2_Init(void)
{
  ...
  // HAL_TIM_IC_Start_DMA(&htim2, TIM_CHANNEL_1, (uint32_t*)&IC1BUF, 1);
  // HAL_TIM_IC_Start_DMA(&htim2, TIM_CHANNEL_2, (uint32_t*)&IC2BUF, 1);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    */
    ...
    if (HAL_DMAEx_ConfigMuxSync(&hdma_tim2_ch1, &pSyncConfig) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    hdma_tim2_ch2.Init.PeriphDataAlignment = DMA_PDATAALIGN_BYTE;
